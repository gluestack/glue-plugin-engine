...
var GluestackEngine = (function () {
    ...
    GluestackEngine.prototype.start = function (isRun, noCache, isProd) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        _a.sent();
                        if (!noCache) return [3, 7];
                        return [4, this.startDockerComposeBuild()];
                    case 6:
                        _a.sent();
                        _a.label = 7;
                    case 7: return [4, this.startDockerCompose()];
                    case 8:
                        _a.sent();
                ...
                switch (_e.label) {
                    ...
                    case 4:
                        ...
                        if (!(instance &&
                            ...
                            type === pluginType &&
                            name &&
                            validPlugins.includes(name))) return [3, 17];
                        _e.label = 5;
                    case 5:
                        _e.trys.push([5, 7, , 8]);
    ...
    GluestackEngine.prototype.collectDockerContext = function (details, instance) {
        return __awaiter(this, void 0, void 0, function () {
            var dockerfile, _a, context;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        dockerfile = (0, path_1.join)(process.cwd(), "node_modules", instance.callerPlugin.getName(), this.isProd ? "src/assets/Dockerfile.prod" : "src/assets/Dockerfile");
                        _a = this.isProd;
                        if (!_a) return [3, 2];
                    ...
                    case 2:
                        if (_a) {
                            console.log("> Could not find Dockerfile [Since UP MODE required PRODUCTION Dockerfile] for plugin \"".concat(instance.callerPlugin.getName(), "\" instance \"").concat(instance.getName(), "\". Looking back for Dockerfile..."));
