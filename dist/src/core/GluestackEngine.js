        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        if (!(plugins_1_1 = _e.sent(), _a = plugins_1_1.done, !_a)) return [3, 18];
                    ...
                    case 13:
                        _e.sent();
                        return [3, 17];
                    case 14: return [4, dockerCompose.addOthers(plugin)];
                    case 15:
                        _e.sent();
                        return [3, 17];
                    case 16:
                    ...
                    case 20:
                        ...
                        if (!(!_d && !_a && (_b = plugins_1["return"]))) return [3, 22];
                    ...
                    case 23:
                        ...
                        return [7];
                    case 24: return [7];
                    case 25: return [4, dockerCompose.generate()];
                    case 26:
                        _e.sent();
                        return [2];
                }
