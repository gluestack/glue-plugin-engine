...
exports.deleteEvents = exports.cronsDelete = void 0;
...
function cronsDelete(program, glueStackPlugin) {
    var command = program
        .command("crons:delete")
        .description("List the crons jobs with select option to delete selected events")
        .action(function (args) { return deleteEvents(glueStackPlugin); });
}
exports.cronsDelete = cronsDelete;
function deleteEvents(_glueStackPlugin) {
    return __awaiter(this, void 0, void 0, function () {
        var cronsFilePath, dataFilePath, fileData, choices, prompt, responses;
...
module.exports = { cronsDelete: cronsDelete };
//# sourceMappingURL=cronsDelete.js.map