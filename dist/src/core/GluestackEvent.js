...
var GluestackEvent = (function () {
    ...
    GluestackEvent.prototype.prepareConfigJSON = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var events, app, database, content, backendInstance, _k, _l, _m, table, _o, _p, _q, event, filepath, filecontent, e_5, e_3_1, e_2_1, _r, app_1, app_1_1, event, filepath, filecontent, e_6, e_4_1;
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        events = this.events;
                        app = (0, lodash_1.get)(events, 'app', {});
                        database = (0, lodash_1.get)(events, 'database', {});
                        content = {
                            database: {},
                            app: {}
                        };
                    ...
                    case 8:
                        ...
                        event = _f;
                        filepath = (0, path_1.join)(process.cwd(), backendInstance, 'events', 'database', table, event + '.js');
                        _s.label = 9;
                    case 9:
                        _s.trys.push([9, 11, , 12]);
                        return [4, this.validateEvents(require(filepath)(), "Event ".concat(table, "::").concat(event))];
                    case 10:
                        filecontent = _s.sent();
                    ...
                    case 35:
                        ...
                        event = _j;
                        filepath = (0, path_1.join)(process.cwd(), backendInstance, 'events', 'app', event + '.js');
                        _s.label = 36;
                    case 36:
                        _s.trys.push([36, 38, , 39]);
                        return [4, this.validateEvents(require(filepath)(), "Event ".concat(event))];
                    case 37:
                        filecontent = _s.sent();
