...
var GluestackWatch = (function () {
    ...
    GluestackWatch.prototype.on = function (event, cb) {
        this.watcher.on(event, cb);
    };
    GluestackWatch.prototype.close = function () {
        this.watcher.close();
    };
    GluestackWatch.prototype.restart = function (status) {
        this.isRestarting = status;
    };
    GluestackWatch.prototype.getStatus = function () {
